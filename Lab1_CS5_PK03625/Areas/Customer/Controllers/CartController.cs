    ...
    public class CartController : ControllerBase
    {
        ...
        public async Task<IActionResult> AddCart(int? productId, int? quantity)
        {
            ...
            try
            {
                ...
                response.Data = new GioHang { MaSanPham = productId.Value, Gia = responseSanPhamVM.Data.DonGia, SoLuong = quantity.GetValueOrDefault(1), TenSanPham = responseSanPhamVM.Data.TenSanPham};
            }
            catch (Exception ex)
            {
